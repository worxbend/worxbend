...
object AppModule {
  ...
  val serverInfoRoutes: ZLayer[Server, Nothing, ServerInfoRoutes] = ZLayer.fromFunction(ServerInfoRoutes.apply _)
  val httpApp: ZLayer[MetricsRoutes & ServerInfoRoutes & Server, Nothing, CetusHttpApp] = ZLayer.fromFunction(
