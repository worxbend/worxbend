...
import io.kzonix.nerdgalaxy.service.security.ApiKeyAuthenticationService.ApiKey

class ApiKeyAuthenticationService extends AuthenticationService with LazyLogging {
  ...
  override def supportedType: AuthType = ApiKey

}

object ApiKeyAuthenticationService {
  case object ApiKey extends AuthType
}
