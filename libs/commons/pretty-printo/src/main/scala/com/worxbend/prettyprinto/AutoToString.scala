...
trait AutoToString:
  ...
  protected given prettyPrintoInstance: PrettyPrintable[this.type] = scala.compiletime.deferred

  protected given prettyPrintoConfiguration: Configuration = scala.compiletime.deferred

  override def toString: String = prettyPrintoInstance.asString(this)(using prettyPrintoConfiguration)
